/*Component Name: company configuration action page
Component Functional Details: From here we are managing/ giving extra feature like edit,delete,clone etc for company configuration data .
Created By: chandan 
