...
const WebSitePage = ({ columns, Data, setSortingOptionHandler, sortingOptions, paginationData, setPaginationDataFunc, filteringOptions, setColumnFilteringOptions, handleFetchData }) => {
