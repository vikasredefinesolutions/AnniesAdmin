...
const LandingPage = ({ columns, Data, setSortingOptionHandler, sortingOptions, paginationData, setPaginationDataFunc, filteringOptions, setColumnFilteringOptions, handleFetchData }) => {
