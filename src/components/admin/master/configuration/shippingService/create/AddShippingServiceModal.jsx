...
const AddShippingServiceModal = ({
  ...
  const createShippingService = (fields, resetForm) => {
  ...
  const updateShippingService = (fields, resetForm) => {
    dispatch(setAddLoading(true));
  ...
  const validationSchema = Yup.object({
    name: Yup.string()
      .trim()
      .required(ValidationMsgs.shippingService.nameRequired),
    url: Yup.string()
      .trim()
      .matches(
