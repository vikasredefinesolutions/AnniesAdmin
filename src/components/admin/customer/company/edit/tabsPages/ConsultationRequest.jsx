...
const RequestConsultation = ({ CompanyInfo }) => {
    ...
    const getConsultationRequestByCompanyId = useCallback(
        (pageIndex = 1) => {
            dispatch(setAddLoading(true));

            CompanyInformationServices.getConsultationRequestByCompanyId({
                args: {
            ...
            ConsultationRequestService.updateStatusConsultationRequest(data)
                .then((response) => {
                    if (response.data.success) {
                        ...
                        getConsultationRequestByCompanyId();
                    } else {
                        dispatch(
                            setAlertMessage({
                                type: "danger",
    ...
    return (
        <>
            ...
            <ReactTable
                ...
                fetchData={getConsultationRequestByCompanyId}
